...
export default function FloatingWhatsApp() {
  ...
  return (
    <aside className="whatsapp-contact-widget fixed z-40 h-[52px] w-[52px]" aria-label={t.regionLabel}>
      <a
        ...
        title={t.linkLabel}
        className="flex h-[52px] w-[52px] items-center justify-center rounded-xl bg-gradient-to-b from-[#1aa34a] to-[#138e3e] text-white shadow-md transition-shadow hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-700 focus-visible:ring-offset-2"
      >
        <svg aria-hidden="true" className="h-9 w-9 shrink-0" viewBox="0 0 24 24" fill="currentColor">
      ...
      <button
        ...
        title={t.closeLabel}
        className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 shadow-sm hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-700 focus-visible:ring-offset-2"
      >
        <svg aria-hidden="true" className="h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
